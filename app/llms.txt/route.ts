...
export function GET(): Response {
  ...
  const body = [
    ...
    "aged out are withdrawn from the site's own counts and say so on the page. Catalog",
    "entries are never taken from a secondhand blog post or a video. First-party notes",
    "R21 writes about tools it actually runs live at /blog, listed only when published.",
    "",
    ...
    "## Also",
    "",
    `- [Notes](${SITE_URL}/blog): first-party writing, listed only when published`,
